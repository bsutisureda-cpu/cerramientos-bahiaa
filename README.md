...
7. **Calendario**: sección para agendar anotaciones en cualquier día (pasado o futuro). Cada anotación tiene un checkbox para marcarla como concretada. Los días con anotaciones pendientes muestran un punto en el calendario. Se guarda en el servidor, compartido entre dispositivos.
8. **Vista previa / Descargar PDF**: genera el PDF en el navegador (con [jsPDF](https://github.com/parallax/jsPDF) + [html2canvas](https://github.com/niklasvh/html2canvas), cargados desde CDN) y lo muestra en una vista previa antes de descargarlo como archivo `.pdf`.
